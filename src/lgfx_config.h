...
class LGFX : public lgfx::LGFX_Device
{
#ifdef STANDARD_ST7701
    lgfx::Panel_ST7701  _panel_instance;     // standard RGB ordering
#else
    lgfx::Panel_ST7701_guition_esp32_4848S040 _panel_instance;  // Guition scramble
#endif
    ...
    {
        {
...
#ifdef NO_PSRAM
            cfg.memory_height = 4;     // tiny FB fits SRAM
#else
            ...
            cfg.offset_x = 0;
            cfg.offset_y = 0;
            cfg.pin_rst  = LCD_RST;    // dev board override
            _panel_instance.config(cfg);
        }
